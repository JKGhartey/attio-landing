...
function LovedByBuildersSection() {
  ...
  return (
    <motion.section 
      className="relative bg-[#232529] px-4 md:px-[94px] py-[116px]"
      initial={{ opacity: 0 }}
    ...
    >
      ...
      <motion.div 
        className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-[64px]"
      ...
      <motion.div 
        className="hidden lg:block absolute bottom-2 left-0 w-full"
        initial={{ opacity: 0 }}
        whileInView={{ opacity: 1 }}
        viewport={{ once: true }}
